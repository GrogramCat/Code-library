...
// 字体加粗或者倾斜
android:textSytle="bold"// 设置文字为粗体
// 其他属性
normal, bold, italic// 倾斜
// 代码中设置为
...
// 在设置android:ellipsize="marquee"下,可以设置android:marqueeRepeatLimt滚动次数
// 设置marquee_forever为无限次,需要控件获得焦点
android:marqueeRepeatLimt="marquee_forever"
...
// 关于字体
android:typeface="monospace"// 设置为等宽字体,有以下的值:normal, sans, serif, monospace
// 代码中可以设置自己的字体
